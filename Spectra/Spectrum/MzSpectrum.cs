...
namespace Spectra
{
    public abstract class MzSpectrum<TPeak, TSpectrum> : IMzSpectrum<TPeak>
        where TPeak : MzPeak
        where TSpectrum : MzSpectrum<TPeak, TSpectrum>
    {
        ...
        public MzSpectrum(TSpectrum MZSpectrum)
        ...
        private MzSpectrum(IMzSpectrum<MzPeak> spectrum)
        ...
        IMzSpectrum<TPeak> IMzSpectrum<TPeak>.Extract(double minMZ, double maxMZ)
        {
        ...
        IMzSpectrum<TPeak> IMzSpectrum<TPeak>.FilterByIntensity(IRange<double> intenistyRange)
        {
            return FilterByIntensity(intenistyRange);
        }

        IMzSpectrum<TPeak> IMzSpectrum<TPeak>.CorrectMasses(Func<double, double> convertor)
        {
